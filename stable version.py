...
"""
    ...
    def interactive_menu(self):
        ...
        while True:
            ...
            print(f"{Colors.BLUE}1.  Network Interface Information{Colors.ENDC}")
            print(f"{Colors.BLUE}2.  Network Discovery Scan{Colors.ENDC}")
            print(f"{Colors.BLUE}3.  Port Scanner{Colors.ENDC}")
            print(f"{Colors.BLUE}4.  OS Detection{Colors.ENDC}")
            print(f"{Colors.BLUE}5.  Vulnerability Check{Colors.ENDC}")
            print(f"{Colors.BLUE}6.  Password Strength Checker{Colors.ENDC}")
            print(f"{Colors.BLUE}7.  DNS Lookup{Colors.ENDC}")
            print(f"{Colors.BLUE}8.  Traceroute{Colors.ENDC}")
            print(f"{Colors.BLUE}9.  Generate Report{Colors.ENDC}")
            print(f"{Colors.BLUE}10. Set Target{Colors.ENDC}")
            print(f"{Colors.BLUE}0.  Exit{Colors.ENDC}")
            
            if self.target:
                print(f"\n{Colors.GREEN}Current Target: {self.target}{Colors.ENDC}")
            
            choice = input(f"\n{Colors.YELLOW}Enter your choice (0-10): {Colors.ENDC}")
